...
export const sudanCities: SudanCity[] = [
  ...
  },
  {
    ...
    areas: [
      ...
      { name: "Karrari", nameAr: "كراري" },
      { name: "Um Badda", nameAr: "أم بدة" },
      { name: "Al Daraja", nameAr: "الدارجة" },
    ],
    description: {
  ...
  },
  {
    ...
    areas: [
      ...
      { name: "Halfaya", nameAr: "حلفاية" },
      { name: "Al Dakhla", nameAr: "الدخلة" },
      { name: "Shambat", nameAr: "شمبات" },
      { name: "Al Kadaro", nameAr: "القدارو" },
    ],
    description: {
...
export const propertiesData: Property[] = [
  ...
  },
  {
    ...
    city: "Khartoum",
    region: "khartoum",
    price: { ar: "850,000,000 ج.س", en: "850M SDG" },
    beds: 4,
    baths: 3,
    area: "320 م²",
  ...
  },
  {
    ...
    city: "Khartoum",
    region: "khartoum",
    price: { ar: "420,000,000 ج.س", en: "420M SDG" },
    area: "600 م²",
  ...
  },
  {
    ...
    city: "Wad Madani",
    region: "al-jazirah",
    price: { ar: "350,000,000 ج.س", en: "350M SDG" },
    area: "50 فدان",
  ...
  },
  {
    ...
    city: "Atbara",
    region: "river-nile",
    price: { ar: "180,000,000 ج.س", en: "180M SDG" },
    beds: 5,
    baths: 4,
    area: "450 م²",
  ...
  },
  {
    ...
    city: "Port Sudan",
    region: "red-sea",
    price: { ar: "280,000,000 ج.س", en: "280M SDG" },
    beds: 3,
    baths: 2,
    area: "220 م²",
  ...
  },
  {
    ...
    price: { ar: "120,000,000 ج.س", en: "120M SDG" },
    area: "800 م²",
...
export const statsData = [
  { target: 20, suffix: "+", label: { ar: "سنة من الخبرة", en: "Years of Experience" } },
  { target: 2500, suffix: "+", label: { ar: "عقار تم تسويقه", en: "Properties Marketed" } },
  { target: 4, suffix: "", label: { ar: "دول نعمل فيها", en: "Countries We Operate In" } },
  { target: 18, suffix: "+", label: { ar: "مدينة سودانية", en: "Sudanese Cities Covered" } },
  { target: 98, suffix: "%", label: { ar: "رضا العملاء", en: "Client Satisfaction" } },
